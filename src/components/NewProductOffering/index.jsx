...
export default function index() {
  ...
  return (
    <div className="m-0 p-0">
      <Navbar />
      <div style={{ backgroundColor: "#F0EFF7"}} className="h-40 px-3 lg:h-96 pb-10 pt-5 lg:pt-28">
        ...
        <p className="our-offerings-sub-text text-lg text-black text-center w-11/12 mx-auto font-semibold mt-4">
