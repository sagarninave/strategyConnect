  ...
  return (
    <nav className="navbarCont py-3 lg:px-32 px-8 flex items-center justify-between w-full sticky z-30 top-0">
      ...
      <ul className="items-center xl:flex hidden justify-between w-2/6">
        ...
        <li className="no-underline text-base text-black flex hover:text-gray-500  items-center cursor-pointer">
          <p
            onClick={() => {
          ...
          <img src={arrDown} alt="arrDown" className="ml-1.5" />
          <ul
            className={`bg-white z-50 rounded border ${
              showVertical ? 'block' : 'hidden'
            } border-gray-300 fixed top-14 p-4`}
          >
            <li className="text-sm grey-text hover:text-black">
              <Link to="/coming-soon"> Health-tech</Link>
            </li>
            <li className="text-sm grey-text mt-2 hover:text-black">
            ...
            <li className="text-sm grey-text hover:text-black mt-2 pt-2 top-divide-line">
      ...
      <div className="flex items-center">
        <a
          href="https://platform.strategyconnect.co/"
          target="_blank"
          className="text-base text-black hover:text-gray-500  cursor-pointer lg:flex hidden"
        >
          Your Account
        </a>
        <p
          ...
          className="ml-3.5 py-2 px-3 rounded purple text-white text-sm hover:bg-indigo-900 cursor-pointer"
        >
          Start a project
        </p>
        <img
