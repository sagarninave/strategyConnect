...
function index() {
  return (
    <div style={{ backgroundColor: "#F3F8FC" }}
      ...
      <div className="flex item-center relative lg:mt-5 mr-1.5 lg:mr-0">
        ...
        <div className="flex justify-between ml-4 lg:ml-4 lg:w-6/12 w-44">
          <p className="text-lg grey-text leading-7 ml-20 w-full hidden lg:flex">
            The idea for Strategy Connect germinated as a discussion betwen Haninder and Shubham when they
      ...
      <p className="text-lg lg:pr-24 relative lg:mt-11 lg:leading-7 pr-4 lg:pr-0 leading-6 grey-text">
      ...
      <p className="lg:pr-24 te:block text-lg lg:leading-7 relative pr-4 lg:pr-0 leading-6 grey-text mt-6">
      ...
      <div className="flex item-center relative lg:mt-5">
        <div style={{ backgroundColor: "#fff", width:"431px"}} className="rounded-md mr-20">
          ...
          <p className="text-lg grey-text text-left p-4 ml-4 leading-7 w-full lg:flex">
